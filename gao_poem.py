...
from poem_pre_do import gen_real_poem
...
def main():
    ...
    # Make word_to_ix and ix_to_word
    print("Generating dictionary...")
    word_to_ix, ix_to_word = gen_dictionary(ALL_DATA_PATH)
    word_dim = len(word_to_ix)

    g_config = G_Config(dict_size=word_dim, seq_len=11)
    g_config.cuda = opt.cuda
    d_config = D_Config(dict_size=word_dim)
